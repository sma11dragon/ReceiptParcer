...
export default function Home() {
  ...
  useEffect(() => {
    if (isMobile) {
      console.log("Mobile device detected - Layout optimized");
    }
  }, [isMobile]);
    ...
    <div className="min-h-screen">
      ...
      <nav className="fixed w-full z-50 transition-all duration-300" style={{ background: 'var(--glass-bg)', backdropFilter: 'blur(20px)', borderBottom: '1px solid var(--glass-border)' }}>
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: '80px' }}>
          ...
          <div className="desktop-only" style={{ display: 'none', alignItems: 'center', gap: '2rem' }}>
            <Link href="#features" style={{ color: 'var(--text-secondary)', transition: 'color 0.2s' }} className="hover:text-white">{t.navbar.features}</Link>
            <Link href="#how-it-works" style={{ color: 'var(--text-secondary)', transition: 'color 0.2s' }} className="hover:text-white">{t.navbar.howItWorks}</Link>
            <Link href="#pricing" style={{ color: 'var(--text-secondary)', transition: 'color 0.2s' }} className="hover:text-white">{t.navbar.pricing}</Link>
          </div>
      ...
      <section className="hero-section">
        <div className="container-responsive hero-container">
          <div className="animate-fade-in hero-text-wrapper">
            ...
            <p className="hero-subtitle">
              Empower your finance team with AI-driven receipt capture and real-time synchronization directly from Telegram. Query expenses on Telegram chat and access your web-based dashboard. Save hours, not minutes.
            </p>
            <div className="hero-buttons">
              <Link href="/register" className="btn btn-primary" style={{ padding: '1rem 2rem', fontSize: '1.125rem' }}>{t.hero.cta_primary}</Link>
              <Link href="mailto:demo@daeit.com.sg?subject=Schedule%20Demo%20Request" className="btn btn-outline" style={{ padding: '1rem 2rem', fontSize: '1.125rem' }}>{t.hero.cta_secondary}</Link>
            </div>
          </div>
          <div className="animate-fade-in delay-200 hero-image-wrapper" style={{ position: 'relative' }}>
      ...
      <section id="how-it-works" className="section">
        <div className="container">
          <div className="text-center" style={{ marginBottom: '4rem' }}>
            <h2 style={{ fontSize: '2.5rem', marginBottom: '1rem', fontWeight: 'bold' }}>{t.howItWorks.title}</h2>
            <p style={{ fontSize: '1.25rem', color: 'var(--text-secondary)' }}>{t.howItWorks.subtitle}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="card" style={{ textAlign: 'center', position: 'relative' }}>
              ...
              <h3 style={{ fontSize: '1.25rem', marginBottom: '1rem', fontWeight: '600' }}>{t.howItWorks.step1_title}</h3>
              <p style={{ color: 'var(--text-secondary)', lineHeight: '1.6' }}>
            ...
            <div className="card" style={{ textAlign: 'center', position: 'relative' }}>
              ...
              <h3 style={{ fontSize: '1.25rem', marginBottom: '1rem', fontWeight: '600' }}>{t.howItWorks.step2_title}</h3>
              <p style={{ color: 'var(--text-secondary)', lineHeight: '1.6' }}>
            ...
            <div className="card" style={{ textAlign: 'center', position: 'relative' }}>
              ...
              <h3 style={{ fontSize: '1.25rem', marginBottom: '1rem', fontWeight: '600' }}>{t.howItWorks.step3_title}</h3>
              <p style={{ color: 'var(--text-secondary)', lineHeight: '1.6' }}>
      ...
      <section id="pricing" className="section" style={{ background: 'var(--bg-secondary)' }}>
        <div className="container">
          <div className="text-center" style={{ marginBottom: '4rem' }}>
            <h2 style={{ fontSize: '2.5rem', marginBottom: '1rem', fontWeight: 'bold' }}>{t.pricing.title}</h2>
            <p style={{ fontSize: '1.25rem', color: 'var(--text-secondary)' }}>{t.pricing.subtitle}</p>
          </div>

          <div className="grid pricing-grid" style={{ maxWidth: '1000px', margin: '0 auto' }}>
            {/* Free Plan */}
            <div className="card" style={{ textAlign: 'center' }}>
              <h3 style={{ fontSize: '1.5rem', marginBottom: '0.5rem', fontWeight: '600' }}>{t.pricing.free_title}</h3>
              <p style={{ color: 'var(--text-secondary)', marginBottom: '1.5rem', fontSize: '0.9rem' }}>{t.pricing.free_desc}</p>
              ...
              <ul style={{ textAlign: 'left', marginBottom: '2rem', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                <li style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-secondary)' }}><Check size={16} color="#10B981" /> {t.pricing.free_f1}</li>
                <li style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-secondary)' }}><Check size={16} color="#10B981" /> {t.pricing.free_f2}</li>
                <li style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-secondary)' }}><Check size={16} color="#10B981" /> {t.pricing.free_f3}</li>
                <li style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-secondary)' }}><Check size={16} color="#10B981" /> {t.pricing.free_f4}</li>
              </ul>
              <Link href="/register" className="btn btn-outline" style={{ width: '100%' }}>{t.pricing.free_cta}</Link>
            </div>

            {/* Pro Plan */}
            <div className="card" style={{ textAlign: 'center', border: '2px solid var(--accent-primary)', transform: 'scale(1.05)', position: 'relative' }}>
              <div style={{ position: 'absolute', top: '-12px', left: '50%', transform: 'translateX(-50%)', background: 'var(--accent-primary)', padding: '0.25rem 1rem', borderRadius: '20px', fontSize: '0.75rem', fontWeight: '600' }}>{t.pricing.popular}</div>
              <h3 style={{ fontSize: '1.5rem', marginBottom: '0.5rem', fontWeight: '600' }}>{t.pricing.pro_title}</h3>
              <p style={{ color: 'var(--text-secondary)', marginBottom: '1.5rem', fontSize: '0.9rem' }}>{t.pricing.pro_desc}</p>
              <div style={{ marginBottom: '1.5rem' }}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem' }}>
                  <span style={{ fontSize: '3rem', fontWeight: 'bold', color: '#10B981' }}>{t.pricing.pro_price_promo || 'FREE'}</span>
                  <span style={{ fontSize: '0.875rem', color: 'var(--text-secondary)', textAlign: 'center' }}>{t.pricing.pro_price_after || '$8/user/month after March 31, 2026'}</span>
                </div>
              </div>
              <ul style={{ textAlign: 'left', marginBottom: '2rem', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                <li style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-secondary)' }}><Check size={16} color="#10B981" /> {t.pricing.pro_f1}</li>
                <li style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-secondary)' }}><Check size={16} color="#10B981" /> {t.pricing.pro_f2}</li>
                <li style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-secondary)' }}><Check size={16} color="#10B981" /> {t.pricing.pro_f3}</li>
                <li style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-secondary)' }}><Check size={16} color="#10B981" /> {t.pricing.pro_f4}</li>
                <li style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-secondary)' }}><Check size={16} color="#10B981" /> {t.pricing.pro_f5}</li>
              </ul>
              <Link href="/register" className="btn btn-primary" style={{ width: '100%' }}>{t.pricing.pro_cta}</Link>
            </div>

            {/* Enterprise Plan */}
            <div className="card" style={{ textAlign: 'center' }}>
              <h3 style={{ fontSize: '1.5rem', marginBottom: '0.5rem', fontWeight: '600' }}>{t.pricing.enterprise_title}</h3>
              <p style={{ color: 'var(--text-secondary)', marginBottom: '1.5rem', fontSize: '0.9rem' }}>{t.pricing.enterprise_desc}</p>
              <div style={{ marginBottom: '1.5rem' }}>
                <span style={{ fontSize: '3rem', fontWeight: 'bold' }}>{t.pricing.enterprise_price}</span>
              </div>
              <ul style={{ textAlign: 'left', marginBottom: '2rem', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                <li style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-secondary)' }}><Check size={16} color="#10B981" /> {t.pricing.enterprise_f1}</li>
                <li style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-secondary)' }}><Check size={16} color="#10B981" /> {t.pricing.enterprise_f2}</li>
                <li style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-secondary)' }}><Check size={16} color="#10B981" /> {t.pricing.enterprise_f3}</li>
                <li style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-secondary)' }}><Check size={16} color="#10B981" /> {t.pricing.enterprise_f4}</li>
                <li style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-secondary)' }}><Check size={16} color="#10B981" /> {t.pricing.enterprise_f5}</li>
              </ul>
              <Link href="mailto:sales@daeit.com.sg?subject=Enterprise%20Inquiry" className="btn btn-outline" style={{ width: '100%' }}>{t.pricing.enterprise_cta}</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer style={{ background: 'var(--bg-primary)', padding: '4rem 0', borderTop: '1px solid var(--glass-border)' }}>
        <div className="container">
          <div className="grid footer-grid mb-16">
            <div>
              ...
              <p style={{ color: 'var(--text-secondary)', lineHeight: '1.6', maxWidth: '300px' }}>
                AI-driven receipt capture with real-time synchronization from Telegram. Query expenses via chat and manage everything from your web-based dashboard. Automate your financial life today.
              </p>
            </div>
            <div>
              ...
              <ul style={{ display: 'flex', flexDirection: 'column', gap: '1rem', color: 'var(--text-secondary)' }}>
                <li><Link href="#features" className="hover:text-white transition-colors">{t.navbar.features}</Link></li>
                <li><Link href="#how-it-works" className="hover:text-white transition-colors">{t.navbar.howItWorks}</Link></li>
                <li><Link href="#pricing" className="hover:text-white transition-colors">{t.navbar.pricing}</Link></li>
              </ul>
            </div>
            <div>
              <h4 style={{ fontWeight: 'bold', marginBottom: '1.5rem' }}>{t.footer.resources}</h4>
              <ul style={{ display: 'flex', flexDirection: 'column', gap: '1rem', color: 'var(--text-secondary)' }}>
                <li><Link href="/blog/1" className="hover:text-white transition-colors">{t.blog.title}</Link></li>
                <li><Link href="/register" className="hover:text-white transition-colors">{t.navbar.started}</Link></li>
