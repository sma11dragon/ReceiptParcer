...
export function getReceiptImageUrl(expense: Expense): string {
  ...
  if (expense.storage_provider === 'r2' && expense.drive_file_id) {
    ...
    // Public URL format: https://receiptimages.daeit.com.sg/receipts/{user_id}/{filename}
    const r2BaseUrl = process.env.R2_PUBLIC_URL || 'https://receiptimages.daeit.com.sg';
